export default function CoffeeChats() {
  return (
    <main style={{minHeight:'70vh', padding:'2rem 1rem', marginTop:'2rem'}}>
      <h1 style={{marginBottom:'1rem'}}>Coffee Chats</h1>
      <div style={{position:'relative', width:'100%', height:'70vh', border:'1px solid #E5E7EB', borderRadius:'16px', overflow:'hidden'}}>
        <iframe
