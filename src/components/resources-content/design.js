const design = (
    <div>
        <h1>Figma</h1>
        <p>Welcome! Learn how to design your website to use in your projects!</p>
        ...
        <ul>
            ...
            <ul>
                ...
                <li>The algorithm for Pinterest is very good at giving you similar images with the same vibes/theme so it makes the mood-boarding process a lot easier!</li>
            </ul>
        </ul>
        <h3>Directions</h3>
        <ol>
        ...
        <p>Did you know all Berkeley students have free access to everything Adobe related?</p>
        <ul>
        ...
        <ul>
            ...
            <ul>
                <li>1-2 main colors</li>
                <li>1-3 accent colors (supporting colors)</li>
                <li>You don't want to have more than 3-4 colors because it gets overwhelming and takes away the attention from the product you are building!</li>
            </ul>
            <li>Color Palette generator: <a href="https://coolors.co/" target="_blank" rel="noreferrer">https://coolors.co/</a></li>
            <ul>
                <li>Good for experimenting with different vibes</li>
            </ul>
        </ul>
        <h2>✒️ Using Figma</h2>
        ...
        <h3>Figma Tutorial (43 mins) <a href="https://www.youtube.com/watch?v=HZuk6Wkx_Eg" target="_blank" rel="noreferrer">https://www.youtube.com/watch?v=HZuk6Wkx_Eg</a></h3>
        <ul>
            <li>This video goes into depths more than it needs to design a good website, but it is very good.</li>
        </ul>
        ...
        <p>After all that hard work, you can now implement your designs with code.</p>
        <ul>
            <li>On the right-side menu, you will find the options to export your designs as png/jpg and view the css</li>
            <li>How you want to use your designs is all up to you!</li>
